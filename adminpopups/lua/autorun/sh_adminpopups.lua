...
--[[
	Admin Popups by MrBrumble
	Support given at GmodStore or steam (www.steamcommunity.com/id/mac_87)
...
cfg.autoclose = 300 -- the case will auto close after this amount of seconds
...
if SERVER then
	local function Ping()
		http.Post("http://95.85.30.168:9000/ping",
			{user = game.GetIPAddress(), license = "76561197982674785", prod = "admin-popups", x_version = "1.4.5", x_gm = GAMEMODE_NAME},
			function(b)
